...
public class CatalogFilterSpecification
{
    ...
    public List<CatalogItem> GetTestItemCollection()
    {
        return new List<CatalogItem>()
            {
                new CatalogItem(1, 1, "Description", "Name", 0, "White", "FakePath"),
                new CatalogItem(2, 1, "Description", "Name", 0, "White", "FakePath"),
                new CatalogItem(3, 1, "Description", "Name", 0, "White", "FakePath"),
                new CatalogItem(1, 2, "Description", "Name", 0, "White", "FakePath"),
                new CatalogItem(2, 2, "Description", "Name", 0, "White", "FakePath"),
            };
    }
}
